            ...
            <div className='w-[90%] mx-auto'>
                <div className=" py-5 md:py-10">
                    <div className="navbar  flex items-center">
                        ...
                        <div className=" gap-2">
                            <div className="hidden lg:flex gap-4 text-dark/[0.8] font-semibold text-base">
                        ...
                        <div>
                            <button className='flex justify-center items-center gap-4 px-5 py-4 border border-solid border-[#1313131A]/[0.1] rounded-xl text-dark text-xs md:text-base  font-semibold'>
